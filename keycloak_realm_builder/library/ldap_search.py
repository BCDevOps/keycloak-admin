#!/usr/bin/env python
# Credits: https://github.com/unchained-capital/ansible-ldap-modules
...
options:
    ...
    attrs:
        ...
        default: none
        description:
            - A sting with ONE search parameter.
    schema:
        required: false
        default: false
        description:
...
class LdapSearch(object):
    ...
    def __init__(self, module):
        ...
        self.attrlist = [self._utf8_param('attrs')]
...
# SH note: Only accepting one query parameter as a string
    # def _load_attrs(self):
    #     if self.module.params['attrs'] is None:
    #         self.attrlist = None
    #     else:
    #         attrs = self.module.params['attrs']
